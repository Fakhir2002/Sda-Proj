...
public class Doctor_VideoConsultationController implements InitializeUsername {
    ...
    @FXML
    private MedicalRecord videoConsultation;
    @FXML
    ...
    public void initialize(String username) {
        ...
        videoConsultation = new MedicalRecord();
    ...
    public void handlerequests(ActionEvent actionEvent) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/UI/Doctor_MedicalHistory.fxml"));
            Parent newPage = loader.load();

            // Get the controller and pass the selected patient username and current doctor's username
            Doctor_MedicalHistoryController controller = loader.getController();
