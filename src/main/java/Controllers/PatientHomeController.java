...
import OOP.Patient;
import OOP.PatientNotification;
...
public class PatientHomeController implements InitializeUsername {
    ...
    public void HandleBookAppointment(ActionEvent actionEvent) {
        loadPage("/UI/Patient_BookAppointment.fxml", "Book Appointment", BookAppointment);
    }

    public void HandleCompare(ActionEvent actionEvent) {
        loadPage("/UI/Paitent_Comparison.fxml", "Comparison", Compare);
    }

    public void chalochalo(ActionEvent actionEvent) {
        loadPage("/UI/Patient_SubscribePackage.fxml", "Subscribe Package", hello);
    }

    public void HandleFeedback(ActionEvent actionEvent) {
        loadPage("/UI/Patient_SubmitFeedback.fxml", "Feedback", Feedback);
    }

    public void HandleEmergency(ActionEvent actionEvent) {
        loadPage("/UI/Patient_Emergency.fxml", "Emergency", emergency);
    }

    public void HandleFaqs(ActionEvent actionEvent) {
        loadPage("/UI/Patient_Faq.fxml", "FAQs", faqsButton);
    }

    public void HandlePayments(ActionEvent actionEvent) {
        loadPage("/UI/Patient_PayBills.fxml", "Bills", payment);
    }
