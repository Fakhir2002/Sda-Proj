...
public class Admin_HomeController {
    ...
    public void handleremovedoc(ActionEvent actionEvent) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/UI/Admin_RemoveDoctor.fxml"));
            Parent newPage = loader.load();
    ...
    public void handleremovepatient(ActionEvent actionEvent) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/UI/Admin_RemovePatient.fxml"));
            Parent newPage = loader.load();
    ...
    public void handleremovestaff(ActionEvent actionEvent) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/UI/Admin_RemoveStaff.fxml"));
            Parent newPage = loader.load();
    ...
    public void handlehealthcare(ActionEvent actionEvent) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/UI/Admin_HealthcarePackages.fxml"));
            Parent newPage = loader.load();
    ...
    public void handleAddHospital(ActionEvent actionEvent) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/UI/Admin_addHospital.fxml"));
            Parent newPage = loader.load();
